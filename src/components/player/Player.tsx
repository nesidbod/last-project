...
export default class Player extends React.Component<IPlayerProps, IPlayerState> {
        ...
        return (
            <div className="player-container">
                ...
                <div className="player-control-container">
                    <div className="player-control-duration">
                        ...
                        <LinearProgress variant="determinate" value={time}
                            onClick={elem => this.playToTime(elem)}
                    ...
                    <div className="player-control">
                        ...
                        <div className="player-control-play">
                            <IconButton color="primary" className="finder-playlist-header-container-button" component="span" onClick={this.onPlay}>
                ...
                <div style={{ display: 'none' }} >
                    <audio src={track.preview_url} id="player" autoPlay={true}
    ...
    private playToTime = (elem: any) => {
        const time = (elem.clientX - elem.currentTarget.offsetLeft) * 100 / elem.currentTarget.offsetWidth
        const audio = document.getElementById("player") as HTMLMediaElement;
        if (!!audio) {
    ...
    private onTouchStart = (elem: any) => {
        const time = (elem.touches[0].clientX - elem.currentTarget.offsetLeft) * 100 / elem.currentTarget.offsetWidth
        this.setState({ time })
    }
