...
import LinkButton from '../../sComponents/util/LinkButton'
...
class SignUp extends React.Component<ISignUpProps, {}> {
                  ...
                  <Formik
                    ...
                    validationSchema={object().shape({
                      ...
                      password: string()
                        ...
                        .max(256, 'Sorry! Password cannot be more than 256 characters.')
  ...
  private renderEmailInput({ field, form }: FieldProps<ISignUpFormValues>) {
    ...
    return (
      <div className="login-input-container">
        <Input id="email-input" className="login-email" type="email" placeholder='Email' error={emailError} {...field} />
      </div>
    )
  }
  ...
  private renderRepeatPassword({ field, form }: FieldProps<ISignUpFormValues>) {
    ...
    return (
      <div className="login-input-container">
        <Input id="repeat-password-input" className="login-email" type={'password'} placeholder='Password' error={repeatPasswordError} {...field} />
      </div>
    )
  }
  ...
  private renderPasswordInput = ({
    ...
    return (
      <div className="login-input-container">
        <Input id="password-input" className="login-email" type={'password'} placeholder='Password' error={passwordError} {...field} />
      </div>
    )
  }
